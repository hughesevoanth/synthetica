...
<img src="man/figures/README-pca-1.png" alt="" width="100%" />

## Learn more

- `vignette("intro", package = "synthetica")` – the full guided tour
  (iris + a realistic Olink NPX proteomics example).
...
`?simulate_dataset` for the full set of `privacy` knobs.
